...
public class DetectFaceDemo {
    ...
    static String PUBLICFILE = "E:\\www\\java\\public\\";
    static int i=0;

    static {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        faceDetector = new CascadeClassifier("E:\\tmpsoft\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
    }
...
//        String basePicPath = "E:\\www\\java\\public\\";
//        double compareHist = compare_image(basePicPath + "f5.jpg", basePicPath + "f6.jpg");
...
//        CascadeClassifier facebook=new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        ...
        if(rects != null && rects.length >= 1) {
            ...
            double tmpindex = compareImage(image,conv_Mat(PUBLICFILE+"t1.jpg"));
            if( tmpindex > 0.72){
            ...
            if(i==3) {// 获取匹配成功第10次的照片
                Imgcodecs.imwrite(PUBLICFILE + "f3.jpg", image);
            }
        }
        return image;
    }
...
//        CascadeClassifier facebook=new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        // 2 读取测试图片
        String imgPath = PUBLICFILE + "t1.jpg";
        ...
        for (Rect rect : face.toArray()) {
            ...
            imageCut(imgPath, "E:\\www\\java\\public\\"+i+".jpg", rect.x, rect.y, rect.width, rect.height);// 进行图片裁剪
            i++;
        }
        // 6 展示图片
    ...
    public static void writeVideo() {
        ...
        VideoWriter writer=new VideoWriter(PUBLICFILE+"a.mp4",VideoWriter.fourcc('D', 'I', 'V', 'X'), 15.0,size, true);
        while(capture.isOpened()) {
